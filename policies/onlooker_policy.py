"""
Onlooker Bee Policy Network for D-MAPPO-ABC
Optimized for global coordination and load balancing
"""
...
class OnlookerPolicy(nn.Module):
    """
    Policy network for onlooker bee agents
    Architecture: [256, 128] - larger capacity for global coordination
    """
    ...
    def __init__(
        ...
        """
        Initialize onlooker policy network
        ...
        # Policy network (actor) - larger first layer for global patterns
